...
/**
 * <p>The class holding the genshinstrument_lm_instrument_played trigger.</p>
 * 
 * <p>
...
public class InstrumentPlayedTrigger extends SimpleCriterionTrigger<InstrumentPlayedTrigger.TriggerInstance> {
    // It doesn't account for namespaces, so will use genshinstrument_lm_ prefix instead
    public static final ResourceLocation ID = new ResourceLocation("genshinstrument_lm_instrument_played");
