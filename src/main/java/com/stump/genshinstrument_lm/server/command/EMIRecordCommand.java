...
public class EMIRecordCommand {
    ...
    private static int saveRecord(CommandContext<CommandSourceStack> stack) throws CommandSyntaxException {
        ...
        if (saveLoc.getNamespace().equals(GInstrumentMod.MODID)) {
        ...
        try {
            ...
            GInstrumentMod.LOGGER.error("Error encountered while saving record data", e);
            throw new RuntimeException(e);
        }

        stack.getSource().sendSuccess(() -> Component.translatable("commands.genshinstrument_lm.emirecord.success.record_saved"), true);
        return 1;
    }
    ...
    private static int loadRecordToHand(CommandContext<CommandSourceStack> stack, Player target) throws CommandSyntaxException {
        ...
        stack.getSource().sendSuccess(() -> Component.translatable("commands.genshinstrument_lm.emirecord.success.record_burned"), true);
        return 1;
    }
    ...
    private static int removeRecord(CommandContext<CommandSourceStack> stack) throws CommandSyntaxException {
        ...
        if (name.getNamespace().equals(GInstrumentMod.MODID))
        ...
        stack.getSource().sendSuccess(() -> Component.translatable("commands.genshinstrument_lm.emirecord.success.record_removed"), true);
        return 1;
    }
}
