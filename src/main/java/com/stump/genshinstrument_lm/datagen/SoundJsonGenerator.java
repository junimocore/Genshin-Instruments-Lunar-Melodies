...
public class SoundJsonGenerator extends SoundDefinitionsProvider {
    ...
    public void registerSounds() {
        registerInstrument("windsong_lyre", 20, 0.9f, false, true);

        registerInstrument("vintage_lyre", 20, 1, false, false);

        registerInstrument("floral_zither_new", 20, 0.8f, false, false);
        registerInstrument("floral_zither_old", 20, 0.9f, false, false);

        registerInstrument("ukulele", 20, 0.9f, false, false);

        registerInstrument("djem_djem_drum", 7, 1f, false, false);

        registerInstrument("nightwind_horn", 13, 1f, true, true);

        registerInstrument("shamisen", 20, 0.8f, false, true);

        registerInstrument("koto", 20, 0.8f, false, false);

        registerInstrument("pipa_regular", 20, 1f, false, false);
        registerInstrument("pipa_tremolo", 20, 1f, false, false);

        registerInstrument("keyboard", 20, 1f, false, true);
        registerInstrument("keyboard_gw2", 20, 0.65f, false, true);
        registerInstrument("keyboard_yamaha_c5", 20, 0.45f, false, true);

        registerInstrument("trombone", 20, 1f, false, false);
        registerInstrument("trumpet_westgate_studios", 20, 0.8f, true, true);
        registerInstrument("trombone_phgm", 20, 0.85f, true, true);

        registerInstrument("saxophone", 20, 1f, false, false);
        registerInstrument("saxophone_baritone", 20, 0.8f, true, true);
        registerInstrument("saxophone_tenor", 20, 0.5f, true, true);

        registerInstrument("guitar", 20, 1f, false, false);

        registerInstrument("violin_slow", 20, 0.9f, true, true);
        registerInstrument("violin_fast", 20, 0.7f, true, true);
        registerInstrument("violin_pizzicato", 20, 0.8f, false, true);

        registerInstrument("microphone_irina_brochin", 20, 0.5f, true, true);
        registerInstrument("microphone_bass_choir", 20, 0.85f, true, true);
        registerInstrument("microphone_not_miku", 20, 0.9f, true, true);

        registerInstrument("gw2_bass", 13, 1f, false, true);
        registerInstrument("gw2_bell", 13, 0.85f, false, true);
        registerInstrument("gw2_harp", 20, 0.85f, false, true);
        registerInstrument("gw2_lute", 20, 0.9f, false, true);
        registerInstrument("gw2_minstrel", 20, 0.8f, false, true);
        registerInstrument("gw2_pell", 20, 0.85f, false, true);
        registerInstrument("gw2_drum", 9, 0.95f, false, true);
        registerInstrument("gw2_horn", 20, 1f, true, true);
        registerInstrument("gw2_flute", 13, 1f, true, true);
        registerInstrument("gw2_verdarach", 20, 0.7f, true, true);
        registerInstrument("gw2_organ", 20, 1f, true, true);
        registerInstrument("gw2_quaggan_organ", 20, 1f, true, true);
        ...
        for (int i = 0; i <= maxNotes; i++) {
            if (!heldSound) {
                ...
                if (supportsStereo) {
                    ...
                    add(holdStereoEvent, definition().with(sound(holdStereoPath).volume(volume)));
                }
                String attackPath = "genshinstrument_lm:" + instrumentName + "/attack/" + i;
                String attackEvent = instrumentName + "_attack_note_" + i;
                add(attackEvent, definition().with(sound(attackPath).volume(volume)));
                if (supportsStereo) {
                    ...
                    add(attackStereoEvent, definition().with(sound(attackStereoPath).volume(volume)));
                }
            }
        }
    }
