package com.stump.genshinstrument_lm.client.gui.instrument.gw2_organ;
...
public class Gw2OrganScreen extends GridInstrumentScreen {
    public static final ResourceLocation INSTRUMENT_ID = new ResourceLocation(GInstrumentMod.MODID, "gw2_organ");

    @Override
    public SoundOption getSoundOption() {
        return new SoundOption(GISounds.GW2_ORGAN);
    }
