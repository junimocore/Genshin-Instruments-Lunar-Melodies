...
public class MicrophoneStandScreen extends GridInstrumentScreen implements IHeldInstrumentScreen {
    public static final ResourceLocation INSTRUMENT_ID = new ResourceLocation(GInstrumentMod.MODID, "microphone_stand");
    public static final ResourceLocation INSTRUMENT_THEME_ID = new ResourceLocation(GInstrumentMod.MODID, "microphone");
