package com.stump.genshinstrument_lm.client.gui.instrument.gw2_pell;
...
@OnlyIn(Dist.CLIENT)
public class Gw2PellScreen extends GridInstrumentScreen {
    public static final ResourceLocation INSTRUMENT_ID = new ResourceLocation(GInstrumentMod.MODID, "gw2_pell");

    @Override
    public SoundOption getSoundOption() {
        return new SoundOption(GISounds.GW2_PELL);
    }
