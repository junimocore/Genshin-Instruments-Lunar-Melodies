package com.stump.genshinstrument_lm.client.gui.instrument.gw2_verdarach;
...
public class Gw2VerdarachScreen extends GridInstrumentScreen {
    public static final ResourceLocation INSTRUMENT_ID = new ResourceLocation(GInstrumentMod.MODID, "gw2_verdarach");

    @Override
    public SoundOption getSoundOption() {
        return new SoundOption(GISounds.GW2_VERDARACH);
    }
