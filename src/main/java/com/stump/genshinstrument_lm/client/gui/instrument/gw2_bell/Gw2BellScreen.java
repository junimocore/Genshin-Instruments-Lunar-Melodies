package com.stump.genshinstrument_lm.client.gui.instrument.gw2_bell;
...
@OnlyIn(Dist.CLIENT)
public class Gw2BellScreen extends GridInstrumentScreen {
    public static final ResourceLocation INSTRUMENT_ID = new ResourceLocation(GInstrumentMod.MODID, "gw2_bell");

    @Override
    public SoundOption getSoundOption() {
        return new SoundOption(GISounds.GW2_BELL);
    }
