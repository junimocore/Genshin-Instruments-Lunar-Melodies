package com.stump.genshinstrument_lm.client.gui.instrument.gw2_quaggan_organ;
...
@OnlyIn(Dist.CLIENT)
public class Gw2QuagganOrganScreen extends GridInstrumentScreen {
    public static final ResourceLocation INSTRUMENT_ID = new ResourceLocation(GInstrumentMod.MODID, "gw2_quaggan_organ");

    @Override
    public SoundOption getSoundOption() {
        return new SoundOption(GISounds.GW2_QUAGGAN_ORGAN);
    }
