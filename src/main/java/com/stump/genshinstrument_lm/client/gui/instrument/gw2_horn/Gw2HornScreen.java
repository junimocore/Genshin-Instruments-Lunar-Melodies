package com.stump.genshinstrument_lm.client.gui.instrument.gw2_horn;
...
@OnlyIn(Dist.CLIENT)
public class Gw2HornScreen extends GridInstrumentScreen {
    public static final ResourceLocation INSTRUMENT_ID = new ResourceLocation(GInstrumentMod.MODID, "gw2_horn");

    @Override
    public SoundOption getSoundOption() {
        return new SoundOption(GISounds.GW2_HORN);
    }
