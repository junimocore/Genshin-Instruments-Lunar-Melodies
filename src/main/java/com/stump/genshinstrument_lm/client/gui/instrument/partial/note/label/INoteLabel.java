package com.stump.genshinstrument_lm.client.gui.instrument.partial.note.label;
...
public interface INoteLabel {
    // Useful stuff
    public static final String TRANSLATABLE_PATH = "genshinstrument_lm.label.";
    public static final String BUTTON_TRANS_PATH = "button.genshinstrument_lm.label.";
