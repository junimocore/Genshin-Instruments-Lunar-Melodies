...
public class BurnedRecordItem extends EMIRecordItem {
    ...
    public BurnedRecordItem(Properties properties, ResourceLocation burnedMedia, @Nullable String info, @Nullable String arranger) {
        this(properties, burnedMedia, info, arranger, Component.translatable("item.genshinstrument_lm.burned_record"));
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        if (arranger != null) {
            pTooltipComponents.add(
                Component.translatable("item.genshinstrument_lm.record.arranger", arranger)
                    .withStyle(ChatFormatting.GRAY)
