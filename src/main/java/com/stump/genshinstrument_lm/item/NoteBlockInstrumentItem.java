...
import com.stump.genshinstrument_lm.networking.packet.OpenNoteBlockInstrumentPacket;
...
public class NoteBlockInstrumentItem extends InstrumentItem {
    ...
    public NoteBlockInstrumentItem(NoteBlockInstrument instrument) {
        super((player) -> GIPacketHandler.sendToClient(
    ...
    public Component getName(ItemStack pStack) {
        return Component.translatable("item.genshinstrument_lm.note_block_instrument", getInstrumentName());
    }
